...
class Elementor_Cards {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Elementor_Cards_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'ELEMENTOR_CARDS_VERSION' ) ) {
			$this->version = ELEMENTOR_CARDS_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'elementor-cards';
	 ...
	 *
	 * - Elementor_Cards_Loader. Orchestrates the hooks of the plugin.
	 * - Elementor_Cards_i18n. Defines internationalization functionality.
	 * - Elementor_Cards_Admin. Defines all hooks for the admin area.
	 * - Elementor_Cards_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Elementor_Cards_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Elementor_Cards_Loader    Orchestrates the hooks of the plugin.
	 */
